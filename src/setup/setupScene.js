...
// Setup World
    ...
    sceneMeshStack.push(skyOutsideMesh);
    ...
    sceneMeshStack.push(rotatingCube)
    
    sceneMeshStack.forEach(m => scene.add(m));

    return function (currentSession, delta, time, data_in, sendData_out, isInsidePortal, globalPlaneInside, globalPlaneOutside) {
        const data_out = {};

        // if (typeof data_in === "object" && data_in != null) {
        //     const { isInsidePortal, globalPlaneInside, globalPlaneOutside } = data_in;
